...
`;
    ...
    // Generate visual per-question feedback for display
    ...
    // Handle the manual feedback button click to request AI feedback
    ...
    return (
        <div className="page3-container">
            <h1 className="page3-header">UK Rules of the Road Quiz</h1>
            {!isQuizFinished ? (
                ...
                <div className="quiz-results">
                    ...
                    <p>
                        Percentage:{" "}
                        {(getScore() / questions.length * 100).toFixed(1)}%
                    </p>
                    <h3>Feedback:</h3>
