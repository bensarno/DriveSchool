...
import quizData from './Questions/FAandESQQuestions.json'; 
...
function FAandESQ({ onQuizFeedback, onReturnToMain }) {
    ...
    const handleSendFeedbackManually = async () => {
        ...
        const summaryText =
            ...
            just say Q1 ect.. dont repeat the users answers. just use one sentence for each question telling the user the right answer and why,
            respond to each question on a new line` +
    ...
    return (
        <div className="page3-container">
            <h1 className="page3-header">UK First Aid and Emergency Situations Quiz</h1>
            {!isQuizFinished ? (
